...
out_data_path = os.path.join("results", "nestedner_dev.xlsx")
...
Bert_SL_model = BertSLPredictor(
    model_dir="exp/0817_8786_concat_num/sl/2021-01-12-05-V3.0-flatner@hfl@chinese-bert-wwm@CE_S-512_B-8_E-40_LR-5e-5_SD-1_load-best/",
    with_bilstmcrf=False,
)
BertBiLSTMCRF_SL_model = BertSLPredictor(
    model_dir="exp/0817_8786_concat_num/sl/2021-01-12-06-V3.0-flatner@hfl@chinese-bert-wwm@BiLSTMCRF_S-512_B-8_E-40_LR-5e-5_SD-1_load-best",
    with_bilstmcrf=True,
)
# Bert_QASL_model = BertQASLPredictor(
#     model_dir="exp/0817_8786_concat_num/simqasl/2021-01-12-09-V3.0-flatner@hfl@chinese-bert-wwm@wCE-0.11-1-0.16_S-512_B-8_E-40_LR-5e-5_SD-1_load-best",
#     with_bilstmcrf=False,
# )
# BertBiLSTMCRF_QASL_model = BertQASLPredictor(
#    model_dir="exp/0817_8786_concat_num/simqasl/2021-01-21-03-V3.0-flatner@hfl@chinese-bert-wwm@wBiLSTMCRF-0.11-1-0.16_S-512_B-8_E-40_LR-5e-5_SD-1_load-best",
#    with_bilstmcrf=True,
# )
Bert_QASL_model = BertQASLPredictor(
    model_dir="exp/0817_8786_concat_num/simqasl/2021-01-14-01-V3.0-nestedner@hfl@chinese-bert-wwm@wCE-0.11-1-0.16_S-512_B-8_E-40_LR-5e-5_SD-1_load-best",
    with_bilstmcrf=False,
)
BertBiLSTMCRF_QASL_model = BertQASLPredictor(
   model_dir="exp/0817_8786_concat_num/simqasl/2021-01-18-01-V3.0-nestedner@hfl@chinese-bert-wwm@wBiLSTMCRF-0.11-1-0.16_S-512_B-8_E-40_LR-5e-5_SD-1_load-best/checkpoint-110000",
   with_bilstmcrf=True,
)
...
for i, d in enumerate(tqdm(data)):
    ...
    for r in flat_ne_answers:
        ...
        flat_ne_answers_set.add((r["type"], r["start_pos"], r["end_pos"]))
    ...
    for r in nested_ne_answers:
        ...
        nested_ne_answers_set.add((r["type"], r["start_pos"], r["end_pos"]))
    ...
    for r in bert_sl_pred_entities:
        ...
        bert_sl_pred_entities_set.add((r.type, r.start_pos, r.end_pos))
    ...
    for r in bertbilstmcrf_sl_pred_entities:
        ...
        bertbilstmcrf_sl_pred_entities_set.add((r.type, r.start_pos, r.end_pos))
    ...
    for r in sorted(bert_qasl_pred_entities, key=lambda x: x.start_pos):
        ...
        bert_qasl_pred_entities_set.add((r.type, r.start_pos, r.end_pos))
    ...
    for r in sorted(bertbilstmcrf_qasl_pred_entities, key=lambda x: x.start_pos):
        ...
        bertbilstmcrf_qasl_pred_entities_set.add((r.type, r.start_pos, r.end_pos))
